...
const projectsRu = {
  'project1': {
    ...
    description: 'Разработка современного веб-сайта для аренды автомобилей премиум-класса в Дубае с удобной системой бронирования.',
  ...
  'project5': {
    ...
    fullDescription: `Проект представляет собой комплексное решение для компании, специализирующейся на производстве и продаже Бенто тортов.
    Сайт разработан с учетом специфики кондитерского бизнеса и потребностей клиентов, предоставляя удобный интерфейс для выбора и заказа тортов.
    
    Особенности проекта:
    • Система онлайн-заказа и оплаты
    • Каталог тортов с фильтрацией
    • Система управления заказами
    • Интеграция с сервисами доставки
    • Мобильная версия с адаптивным дизайном`,
    images: [
    ...
    challenges: [
      ...
      'Оптимизация изображений тортов'
    ],
    solutions: [
      'Разработка API для интеграции с доставкой',
...
const projectsEn = {
  ...
  'project5': {
    ...
    • Catalog of cakes with filtering
    • Order management system
    • Integration with delivery services
    • Mobile version with responsive design`,
    images: [
    ...
    solutions: [
      'Development of API for integration with delivery',
